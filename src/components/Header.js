...
import headerBackground from'../services/images/bgvideo.mp4'
  ...
  return (
    <header className='css-header'>
      ...
      <div className='css-header-caption-div'>
        <h1 style={{color: 'White'}}>STAY FOCUSED</h1>
        <p style={{color: 'white'}}>Discover something that you are intresed in, <br></br>in a single click</p>
